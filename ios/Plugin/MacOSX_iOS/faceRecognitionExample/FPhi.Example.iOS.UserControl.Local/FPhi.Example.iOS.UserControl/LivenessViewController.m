...
- (IBAction) AuthenticateUserClick:(UIButton *)sender {
    ...
    _widget.extractionMode = EMWizardLiveness;
...
-(void) ExtractionFinished {
    ...
    // Get liveness biometric data
    if (_widget.livenessDiagnostic != FPBLivenessDiagnosticLivenessDetected) {
        NSString *message = nil;
        switch (_widget.livenessDiagnostic) {
            case FPBLivenessDiagnosticUnsuccess:
                message = NSLocalizedString(@"LivenessFail", nil);
                break;
                
            case FPBLivenessDiagnosticUnsuccessLight:
                message = NSLocalizedString(@"LivenessFailLight", nil);
                break;
                
            case FPBLivenessDiagnosticUnsuccessGlasses:
                message = NSLocalizedString(@"LivenessFailGlasses", nil);
                break;
                
            case FPBLivenessDiagnosticUnsuccessLowPerformance:
                message = NSLocalizedString(@"LivenessFailPerformance", nil);
                break;
